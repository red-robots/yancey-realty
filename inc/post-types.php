...
$labels = array(
  ...
  register_post_type('development',$args); // name used in query
     ...
     $labels = array(
  'name' => _x('Subdivisions & Complexes', 'post type general name'),
    'singular_name' => _x('Subdivisions & Complexes', 'post type singular name'),
    'add_new' => _x('Add New', 'Subdivisions & Complexes'),
    'add_new_item' => __('Add New Subdivisions & Complexes'),
    'edit_item' => __('Edit Subdivisions & Complexes'),
    'new_item' => __('New Subdivisions & Complexes'),
    'view_item' => __('View Subdivisions & Complexes'),
    'search_items' => __('Search Subdivisions & Complexes'),
    'not_found' =>  __('No Subdivisions & Complexes found'),
    'not_found_in_trash' => __('No Subdivisions & Complexes found in Trash'), 
    'parent_item_colon' => '',
    'menu_name' => 'Subdivisions & Complexes'
  );
  $args = array(
  'labels' => $labels,
    'public' => true,
    ...
    'show_in_menu' => true, 
    'query_var' => true,
    'rewrite' => array('slug' => 'subdivision-complex'),
    'capability_type' => 'post',
    'has_archive' => false, 
    'hierarchical' => false, // 'false' acts like posts 'true' acts like pages
    'menu_position' => 20,
  ...
  register_post_type('subdivision',$args); // name used in query
